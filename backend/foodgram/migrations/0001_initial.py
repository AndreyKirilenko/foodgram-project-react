# Generated by Django 3.0.5 on 2021-09-19 11:42
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('ingredients', models.ManyToManyField(through='foodgram.Quantity_ingredients', to='foodgram.Ingredients', verbose_name='Ингридиенты')),
            ],
            options={
                'verbose_name': 'Рецепт',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('slug', models.SlugField(default=uuid.uuid1, max_length=200, unique=True, verbose_name='Уникальный слаг')),
            ],
            options={
                'verbose_name': 'Тег',
        ...
        migrations.AddConstraint(
            ...
            constraint=models.UniqueConstraint(fields=('author', 'user'), name='author_follows'),
        ),
        migrations.AddConstraint(
            model_name='favorite',
